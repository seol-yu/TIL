...
# DB 생성 & Auto Commit
# 본인 DB 경로
conn = sqlite3.connect('C:/Users/seoly/Desktop/GITHUB/seol-yu/TIL/Python/Python_Basic_To_Advanced/Python/python_basic/resource/records.db', isolation_level=None)
