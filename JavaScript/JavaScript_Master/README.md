...
프로토타입 Prototype 이용해서 생성자 함수 지원(객체지향 프로그래밍)

보통은 클래스 기반으로 객체지향 프로그래밍(es6 이후 클래스 도입)

<br />

클래스: 객체를 생성할 수 있는 템플릿(청사진, 틀)

클래스, 생성자 함수 이용해서 객체지향 프로그래밍 가능 Object-Oriented Programming

<br />

클래스 이용해서 객체 만들 수 있는데

클래스를 이용해 만들어진 객체를 인스턴스라고 한다 Instance
...
클래스 레벨의 프로퍼티와 메소드 <- static 키워드 사용. 인스턴스에 포함되지 않고 클래스에 남아있음. 
