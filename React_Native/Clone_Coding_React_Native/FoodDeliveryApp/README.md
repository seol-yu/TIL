...
[ios]git-lfs로 추가 설치 필요 [참고](https://github.com/navermaps/ios-map-sdk#대용량-파일을-받기-위해-git-lfs-설치가-필요합니다)
...
- [Android](http://romannurik.github.io/AndroidAssetStudio/icons-launcher.html#foreground.type=image&foreground.space.trim=1&foreground.space.pad=0.25&foreColor=rgba(96%2C 125%2C 139%2C 0)&backColor=rgb(255%2C 255%2C 255)&crop=0&backgroundShape=square&effects=none&name=ic_launcher) 다운받은 후 android/app/src/main 아래에 넣기
...
[링크](https://github.com/DylanVann/react-native-fast-image) src/slices/order.ts
...
axios@0.24 설치(axios@0.25.0에 문제 있음) [링크](https://github.com/axios/axios/issues/4406)
